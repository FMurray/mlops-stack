...
dbutils.widgets.text(
    "model_name", "forrest_murray.my_mlops_project.my_mlops_project-model", label="Full (Three-Level) Model Name"
)

# Pickup features table name
dbutils.widgets.text(
    "pickup_features_table",
    "forrest_murray.my_mlops_project.trip_pickup_features",
...
dbutils.widgets.text(
    ...
    "forrest_murray.my_mlops_project.trip_dropoff_features",
